        ...
        case "matscraft":
          try {
            ...
            await interaction.reply({
              content:
                "There was an error accessing MatsCraft manager. Please try again.",
              ephemeral: true,
            });
          }
          break;
            ...
            if (token) {
              ...
              if (expiresAt > now) {
                const verificationEmbed = new EmbedBuilder()
                  ...
                  .setDescription(
                    `Your verification code is: \`${token.verification_token}\`\n\n` +
                      "To link your account:\n" +
                      "1. Join the matsCraft server\n" +
                      "2. Type `/link` in the game chat\n" +
                      "3. Enter this code when prompted\n\n" +
                      `⏱️ Code expires <t:${Math.floor(
                        expiresAt.getTime() / 1000
                      )}:R>`
                  )
                  .setColor(COLORS.PRIMARY)
                  .setFooter({
                    text: "⚠️ This code will expire in exactly 5 minutes",
                  });
                ...
                const expiredEmbed = new EmbedBuilder()
                  ...
                  .setDescription(
                    "This verification code has expired. Please generate a new one."
                  )
